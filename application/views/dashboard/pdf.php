...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td colspan="10" align="center" style="font-size: 18px; font-weight: bold;">PT. SUTRAKABEL</td>
    </tr>
    <tr>
        <td colspan="10" align="center" style="font-size: 18px; font-weight: bold;">DATA PENGUNJUNG BULAN <?= $bln_sekarang ?></td>
    </tr>
    <tr>
        <td colspan="10" align="center" style="font-size: 18px; font-weight: bold;"><?= $tahun; ?></td>
    </tr>
</table>
<br>
    ...
    <tbody>
        ...
        foreach ($data_bukutamu as $hasil) { ?>
            <tr>
                ...
                <td style="padding: 10px;"><?php if ($hasil->jenis_kelamin == 1) {
                                                echo "Laki-Laki";
                                            } else {
                                                echo "Perempuan";
                                            } ?></td>
                ...
                <td style="padding: 10px;"><?php $tgl = date("d M Y", strtotime($hasil->tanggal));
                                            echo $tgl ?></td>
...
<table width="100%">
    <tr>
        ...
        <td colspan="20" align="center" style="font-size: 13px; font-weight: bold; padding-left: 600px;">
        </td>
    </tr>
    <tr>
        <td colspan="20" align="center" width="50%" style="font-size: 14px; font-weight: bold;">&nbsp;</td>
        <td colspan="20" align="center" style="font-size: 14px; font-weight: bold;">Bogor, <?= date("d F Y") ?> <br /> Satpam Jaga,</td>
    </tr>
    <tr>
